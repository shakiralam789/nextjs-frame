...
export const Button = ({
  ...
  const baseClasses =
    "min-w-fit flex items-center justify-center font-medium px-3 font-16 py-2 2xl:py-2.5 text-center rounded-lg transition-colors focus:outline-none";

  const variantClasses = {
    primary:
      "bg-primary-purple text-white hover:bg-purple-700 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2",
    danger:
  ...
  if (plus) {
    if (
      ...
      displayIcon = (
        <PlusIcon
          className={cn("h-4 w-4", iconPosition === "left" ? "mr-2" : "ml-2")}
        />
      );
...
export const IconButton = ({
  ...
  const baseClasses =
    "flex items-center justify-center p-2 rounded-md transition-colors focus:outline-none";
